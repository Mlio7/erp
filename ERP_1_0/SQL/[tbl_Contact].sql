...
GO
	...
	------2. [tbl_Company]
	----			ALTER TABLE [dbo].[tbl_Contact]  WITH CHECK ADD  CONSTRAINT [FK_ContactResponsibleUserID] FOREIGN KEY([ResponsibleUserID])
	----			REFERENCES [dbo].[tbl_Users] ([ID])
	----			GO
	----			ALTER TABLE [dbo].[tbl_Contact] CHECK CONSTRAINT [FK_ContactResponsibleUserID]
	----			GO
	------2.1 [tbl_Company]
